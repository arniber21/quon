...
fn spider_fusion(_zx: &mut ZXGraph) -> bool { todo!() }
fn identity_removal(_zx: &mut ZXGraph) -> bool { todo!() }
fn pi_copy(_zx: &mut ZXGraph) -> bool { todo!() }
fn bialgebra(_zx: &mut ZXGraph) -> bool { todo!() }
fn euler_decomposition(_zx: &mut ZXGraph) -> bool { todo!() }
fn color_change(_zx: &mut ZXGraph) -> bool { todo!() }
fn state_copy(_zx: &mut ZXGraph) -> bool { todo!() }
